...
# TODO: 
- [small] may need to change "save_root" -> since it is writing to the same thing as odd_even .. 


# NEXT STEPS: 
- implement DPS with DDPM_only trained DDM 
    - first need to implement standard inferrence lol 
        - check how iteration is implemented in DPS - and implement it for DDM ... 
